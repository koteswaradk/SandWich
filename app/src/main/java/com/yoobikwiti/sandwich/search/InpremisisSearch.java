...
public class InpremisisSearch extends Activity implements OnCheckedChangeListener,
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchAdapter = new CustomerSearchAdapter(InpremisisSearch.this, customerSearch);
		searchlistview.setOnItemClickListener(new OnItemClickListener() {
			...
			final Dialog dialog = new Dialog(InpremisisSearch.this);
            ...
            btnupdate.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startActivity(new Intent(InpremisisSearch.this, CustomerDetalsActivity.class));
				}
			});
            btntakeorder.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startActivity(new Intent(InpremisisSearch.this, TakeOrder.class));
				}
			});
	...
	AsyncTask<Void, Void, ArrayList<CustomerSearchModel>>{
		...
		protected void onPreExecute() {
			...
			if (progressDialog == null) {
				progressDialog = new ProgressDialog(InpremisisSearch.this);
		...
		protected ArrayList<CustomerSearchModel> doInBackground(Void... params) {
			// TODO Auto-generated method stub
			DataHelper databasehelper = new DataHelper(InpremisisSearch.this);
			databasehelper.open();
		...
		protected void onPostExecute(ArrayList<CustomerSearchModel> result) {
			...
			if (!flag_data) {
				...
				Toast.makeText(InpremisisSearch.this, "valid Pnone Number Please",
	...
	public class GetSearcByNameAsync extends
		...
		protected void onPostExecute(ArrayList<CustomerSearchModel> result)
		{
			...
			if (!flag_data) {
				...
				searchlistview.setAdapter(null);
				searchAdapter.notifyDataSetChanged();
				Toast.makeText(InpremisisSearch.this, "valid Name Please",
						Toast.LENGTH_SHORT).show();
